...
class TorrentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create torrent" do
    assert_difference('Torrent.count') do
      post torrents_url, params: { torrent: { main: @torrent.main, release_year: @torrent.release_year, title: @torrent.title, url: @torrent.url } }
    end
  ...
  test "should update torrent" do
    patch torrent_url(@torrent), params: { torrent: { main: @torrent.main, release_year: @torrent.release_year, title: @torrent.title, url: @torrent.url } }
